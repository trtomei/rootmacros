...
TCanvas* plotHists(vector<TH1*> histogramsToPlot, vector<TString> histogramLabels, TString title="", TString xTitle="", TString yTitle="", bool areaNormalize=false) {
  ...
  histColors.push_back(kGreen+2);
  histColors.push_back(kViolet);
  histColors.push_back(kOrange-1);
  ...
  histMarkerStyles.push_back( 24 );
  histMarkerStyles.push_back( 25 );
  ...
  for (int i=0; i<histogramsToPlot.size(); i++) {
    hists.push_back( (TH1*)histogramsToPlot[i]);
  ...
  tempStack->GetXaxis()->SetLabelSize(0.03);
  tempStack->GetYaxis()->SetLabelSize(0.04);
...
TCanvas* plotHists(TH1* hist1, TH1* hist2, TH1* hist3, TH1* hist4, TH1* hist5, TString title="", TString xTitle="", TString yTitle="", TString label1="", TString label2="", TString label3="", TString label4="", TString label5="", bool areaNormalize=false) {
  vector<TH1*> histogramsToPlot;
  histogramsToPlot.push_back( hist1 );
  histogramsToPlot.push_back( hist2 );
  histogramsToPlot.push_back( hist3 );
  histogramsToPlot.push_back( hist4 );
  histogramsToPlot.push_back( hist5 );
  vector<TString> histogramLabels;
  histogramLabels.push_back( label1 );
  histogramLabels.push_back( label2 );
  histogramLabels.push_back( label3 );
  histogramLabels.push_back( label4 );
  histogramLabels.push_back( label5 );
  TCanvas* c1 = plotHists(histogramsToPlot, histogramLabels, title, xTitle, yTitle, areaNormalize);
  return c1;
}

TCanvas* plotHists(TH1* hist1, TH1* hist2, TH1* hist3, TH1* hist4, TH1* hist5, TH1* hist6, TString title="", TString xTitle="", TString yTitle="", TString label1="", TString label2="", TString label3="", TString label4="", TString label5="", TString label6="", bool areaNormalize=false) {
  vector<TH1*> histogramsToPlot;
  histogramsToPlot.push_back( hist1 );
  histogramsToPlot.push_back( hist2 );
  histogramsToPlot.push_back( hist3 );
  histogramsToPlot.push_back( hist4 );
  histogramsToPlot.push_back( hist5 );
  histogramsToPlot.push_back( hist6 );
  vector<TString> histogramLabels;
  histogramLabels.push_back( label1 );
  histogramLabels.push_back( label2 );
  histogramLabels.push_back( label3 );
  histogramLabels.push_back( label4 );
  histogramLabels.push_back( label5 );
  histogramLabels.push_back( label6 );
  TCanvas* c1 = plotHists(histogramsToPlot, histogramLabels, title, xTitle, yTitle, areaNormalize);
  return c1;
}
